...
QVariant ApiServicesModel::data(const QModelIndex &index, int role) const
{
    ...
    case CardDescriptionRole: {
        ...
        if (serviceType == serviceType::amneziaPremium) {
            return tr("Amnezia Premium is VPN for seamless work, downloading large files, and watching videos. "
                      "Access all websites and online resources. Speeds up to %1 MBit/s. Unlimited traffic.")
                    .arg(speed);
